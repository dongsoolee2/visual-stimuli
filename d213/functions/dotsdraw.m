function ex = dotsdraw(expmode)
% dotsdraw(stim)
% dotsdraw displays a list of stimuli in configuration file (config.json).
%
...
try
    ...
    %Screen('Preference', 'ScreenToHead', 1, 1, 0); % (outdated) use this in a real experiment
