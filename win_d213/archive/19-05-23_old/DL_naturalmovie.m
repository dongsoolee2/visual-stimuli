...
%
% by Dongsoo Lee (edited 19-05-20; edited for mouse exp 19-05-20)
...
try
    ...
    boxes = [X1; Y1; X2; Y2];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    mov = load('/Users/Administrator/Documents/MATLAB/stimulus-DL/mov_Birds_moving objects in whold field_f1811_intensity.mat');
    mov_rs = reshape(mov.mm_intensity, [1811, 360, 640]);
    mov_sample = mov_rs(:, 150:150+numHBoxes-1, 300:300+numHBoxes-1);
    mov_permute = permute(mov_sample, [3 2 1]);
    mov_p_rs = double(reshape(mov_permute, [numHBoxes^2, 1811]))/180;
    ...
    for c = 1:totalFrame
        ...
        %boxColor(1, :, c) = double(b(:, 1))/256;
    end
    pdColor = zeros(3, totalFrame);
    pdColor(1, :) = boxColor(2, 1, :);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
