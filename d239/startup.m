...
addpath(genpath('/home/dlee/Documents/MATLAB/visual-stimuli/d239'));
...
cd('/home/dlee/Documents/MATLAB/visual-stimuli/d239');

% configure display resolution at start up (for CRT MultiSync FE700)
Screen('ConfigureDisplay', 'Scanout', 0, 0, 1024, 768);
SetResolution(0, 1024, 768, 60);
